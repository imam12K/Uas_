        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}">
                    <img src="{{ asset('img/tokoh.png')}}" alt="" width="30" height="30">
                    TOKOH BUNGA
                </a>
                    ...
                    <ul class="nav nav-pills">
                        ...
                        <ul class="nav nav-underline">
                            <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ url('/jenisbunga') }}">Data Jenis Bunga</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ url('/bunga') }}">Data Bunga</a>
                                </li>
                                <li class="nav-item">
